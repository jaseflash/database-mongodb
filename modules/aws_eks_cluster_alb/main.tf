...
module "eks" {
  ...
  access_entries = {
    ...
    test-admin = {
      kubernetes_groups = [""]
      principal_arn     = "arn:aws:iam::865587657226:role/jase-shared-usw2-cluster-20240523141246496600000002"
#     principal_arn     = "arn:aws:iam::729755634065:role/aws_jase_test-admin"
